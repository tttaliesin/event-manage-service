...
from adapter.outbound.persistence.entity import Base
from sqlalchemy import select
from adapter.inbound.websocket.socketio_inbound_adapter import SocketIOInboundAdapter
from adapter.inbound.http.service_log_router import router as log_router
...
async def create_app() -> FastAPI:
    ...
    container.wire(modules=[__name__, "adapter.inbound.http.service_log_router"])
